...
//make preSelected buttons
    ...
    $.ajax({
        ...
        $(".randomGiphyContainer").append(`<div id="${i}div"><img src="${response.data.images.original.url}" id="${i}" width="240" height="180" margin= "2px" border="2px" class="giphy-embed" data-still="${response.data.images.original_still.url}" data-animate="${response.data.images.original.url}" data-state="animate"></img>`)
    ...
    function makeGiphyDiv(argument, BannerName){
        ...
        method: "GET"
            ...
            for (var i = 0; i < response.data.length; i++){
                $(`.${argument}Container`).append(`<div id="${argument}${i}div" class="giphy-embed"><a href=${response.data[i].images.original.url} download><img src="${response.data[i].images.original.url}" width="240" height="180" margin= "2px" border="2px" class="giphy-embed" data-still="${response.data[i].images.original_still.url}" id="${argument}${i}" data-animate="${response.data[i].images.original.url}" data-state="animate"></img></a></div>`)
            }
